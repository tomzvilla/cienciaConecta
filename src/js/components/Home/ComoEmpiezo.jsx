...
const ComoEmpiezo = (props) => {
    return (
        <div className="como-empiezo">
            {window.innerWidth >= 800 ? <img className="como-empiezo__img" src={require("../../../assets/empiezo.jpg")} alt="" /> : ""}
            ...
            {window.innerWidth <= 800 ? <img className="como-empiezo__img" src={require("../../../assets/hero.jpg")} alt="" /> : ""}
