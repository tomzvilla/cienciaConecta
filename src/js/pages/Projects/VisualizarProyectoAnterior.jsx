...
const VisualizarProyectoAnterior = () => {
    const axiosPrivate = useAxiosPrivate()
    const { id } = useParams()
    const { data } = useAxiosFetch(`/proyecto/propietario/${id}`, axiosPrivate)
    ...
    return (
        <>
            ...
            {!data ? <Spinner/> : <ProjectCard formData={project} goBack={'/misProyectos'} antiguo={true}/>}
        </>
    )
}

export default VisualizarProyectoAnterior